...
* Always keep your raw data intact (i.e. read-only). Generate separate analysis datasets to perform analysis.
...
* Run your codes from the replication folder before you submit and make sure it runs and all your results are reproduced. 
